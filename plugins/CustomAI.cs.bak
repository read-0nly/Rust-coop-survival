    ...
    class CustomAI : RustPlugin {
        ...
        private class PluginConfig {
            ...
            public static PluginConfig DefaultConfig() {
				...
				output.AnimalsSettings["Scientist"] = new AnimalConfig() { speed = 1.5f, boostSpeed = 1.7f, health = 150, armor = 0, damage = 10, agressive = true, attackAnimals = true, attackRange = 2 };
                return output;
            }
        }
        class AIConfig {
        ...
        void InitializeConfig() {
            ...
            config.Zombie = pluginConfig.AnimalsSettings["Scientist"];
