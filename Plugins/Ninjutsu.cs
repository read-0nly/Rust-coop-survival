					...
					switch(gesture.gestureCommand)
					{
						...
						case "thumbsdown": //Breaks a powersource connection
							...
							if(nearestGen!=null){
								...
								foreach (IOEntity.IOSlot ioslot3 in io.outputs)
								{
						...
						case "victory": //tesla dmg
							...
							{
                                BaseCombatEntity component = nearbyShocked[i].GetComponent<BaseCombatEntity>();
								if (component)
								{
									component.OnAttacked(new HitInfo(player, component, Rust.DamageType.ElectricShock, 15));
								}
							}
							player.OnAttacked(new HitInfo(player, player, Rust.DamageType.ElectricShock, 10));
							break;
							#endregion
						case "clap": //open door
							#region tech clap
							...
							player.OnAttacked(new HitInfo(nearbyDoors[idxDoor], player, Rust.DamageType.ElectricShock, 20));
							break;
							#endregion
